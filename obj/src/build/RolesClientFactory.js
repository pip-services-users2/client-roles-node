...
const RolesMockClientV1_1 = require("../version1/RolesMockClientV1");
...
class RolesClientFactory extends pip_services3_components_nodex_1.Factory {
    constructor() {
        ...
        this.registerAsType(RolesClientFactory.MockClientV1Descriptor, RolesMockClientV1_1.RolesMockClientV1);
...
RolesClientFactory.MockClientV1Descriptor = new pip_services3_commons_nodex_1.Descriptor('service-roles', 'client', 'mock', 'default', '1.0');
