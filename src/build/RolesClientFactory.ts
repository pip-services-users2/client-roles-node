...
export class RolesClientFactory extends Factory {
	...
	public static HttpClientV1Descriptor = new Descriptor('service-roles', 'client', 'http', 'default', '1.0');
	public static LambdaClientV1Descriptor = new Descriptor('service-roles', 'client', 'lambda', 'default', '1.0');
